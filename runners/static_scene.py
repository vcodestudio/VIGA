...
def main():
    ...
    parser.add_argument("--generator-tools", default="tools/exec_blender.py,tools/generator_base.py,tools/meshy.py", help="Comma-separated list of generator tool server scripts")
