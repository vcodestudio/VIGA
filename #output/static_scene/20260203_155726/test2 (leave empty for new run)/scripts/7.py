...
# Long part of the L
bpy.ops.mesh.primitive_cube_add(size=1, enter_editmode=False, location=(-1.5, 2.0, 0.4))
...
# Short part of the L
bpy.ops.mesh.primitive_cube_add(size=1, enter_editmode=False, location=(0.5, -0.5, 0.4))
...
# Long part of the L
bpy.ops.mesh.primitive_cube_add(size=1, enter_editmode=False, location=(-1.5, 2.0, 0.85))
...
# Short part of the L
bpy.ops.mesh.primitive_cube_add(size=1, enter_editmode=False, location=(0.5, -0.5, 0.85))
...
bpy.ops.mesh.primitive_cube_add(size=1, enter_editmode=False, location=(-1.5, 2.0, 0.05))
light_strip_long = bpy.context.object
light_strip_long.name = "LightStripLong"
light_strip_long.scale = (3.9, 0.5, 0.05)

bpy.ops.mesh.primitive_cube_add(size=1, enter_editmode=False, location=(0.5, -0.5, 0.05))
