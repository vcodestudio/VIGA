"""Visual Question Answering utilities using InstructBLIP."""
import re
...
class VQA:
    """Visual Question Answering class using InstructBLIP model."""

    def __init__(self, gpu_number: int = 0) -> None:
        """Initialize VQA model and processor."""
    ...
    def pre_question(self, question: str) -> str:
        """Preprocess question by cleaning and truncating."""
    ...
    def qa(self, image_path: str, question: str) -> str:
        ...
        generated_ids = self.model.generate(
            **inputs, length_penalty=-1, num_beams=5, max_length=30, min_length=1,
