...
async def main() -> None:
    ...
    parser.add_argument("--resume-memory", default=None, help="Path to generator_memory.json to resume from")
    ...
    parser.add_argument("--prompt-setting", choices=["none", "procedural", "scene_graph", "get_asset", "init", "segment_objects"], default="none", help="Setting for the prompt")
